...
class RnnlmModel(object):
    ...
    def __init__(self, is_training, config, input_):
        ...
        self.initial = tf.reshape(tf.stack(axis=0, values=self._initial_state_single), [config.num_layers, 1, size],
        ...
        test_state_out = tf.reshape(tf.stack(axis=0, values=test_output_state), [config.num_layers, 1, size],
                                    name="test_state_out")
