...
if num_hid_layers == 0 and o.bottleneck_dim != 0:
    ...
    o.activation_type, num_hid_neurons, num_hid_neurons, o.activation_opts)  # Non-linearity
    ...
    if o.with_softmax:
        if o.block_softmax_dims == "":
            print
            "<Softmax> <InputDim> %d <OutputDim> %d" % (num_leaves, num_leaves)
        else:
            print
...
print
"%s <InputDim> %d <OutputDim> %d %s" % (o.activation_type, num_hid_neurons, num_hid_neurons, o.activation_opts)
if o.with_dropout:
    print
    "<Dropout> <InputDim> %d <OutputDim> %d %s" % (num_hid_neurons, num_hid_neurons, o.dropout_opts)
...
if o.with_softmax:
    if o.block_softmax_dims == "":
        ...
        print
        "<BlockSoftmax> <InputDim> %d <OutputDim> %d <BlockDims> %s" % (num_leaves, num_leaves, o.block_softmax_dims)
