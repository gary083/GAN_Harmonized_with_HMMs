...
# The LSTM layers,
print
"<LstmProjected> <InputDim> %d <OutputDim> %d <CellDim> %s" % (feat_dim, o.proj_dim, o.cell_dim) + lstm_extra_opts
for l in range(o.num_layers - 1):
    print
    "<LstmProjected> <InputDim> %d <OutputDim> %d <CellDim> %s" % (o.proj_dim, o.proj_dim, o.cell_dim) + lstm_extra_opts

# Adding <Tanh> for more stability,
print
"<Tanh> <InputDim> %d <OutputDim> %d" % (o.proj_dim, o.proj_dim)
